            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-red-500 focus:text-red-600 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-current="page"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 text-red-500 transition-colors duration-300 hover:text-red-600 focus:text-red-600 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
